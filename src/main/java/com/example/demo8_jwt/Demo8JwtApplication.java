...
public class Demo8JwtApplication {

    public static void main(String[] args) {
        SpringApplication.run(Demo8JwtApplication.class, args);
    }
